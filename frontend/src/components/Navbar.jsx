...
const Navbar = ({ showBottomNav = true }) => {
  ...
  const navItems = [
    ...
    { path: "/Account", icon: <FaHistory />, label: "Account" },
  ]
      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.div
            ...
            className="sidebar fixed z-60 top-0 left-0 h-full w-72 bg-gradient-to-b from-blue-900 to-indigo-950 text-white shadow-2xl"
          >
