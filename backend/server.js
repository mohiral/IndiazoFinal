...
// Serve static files from the 'apk' directory
...
const frontendBuildPath = path.join("../frontend/dist")
if (!fs.existsSync(frontendBuildPath)) {
  console.warn(`Frontend build directory not found at ${frontendBuildPath}. Frontend will not be served.`)
} else {
  ...
  app.get("*", (req, res, next) => {
    ...
    // Fix: Use an absolute path with __dirname
    res.sendFile(path.resolve(__dirname, frontendBuildPath, "index.html"))
  })
}
